...
/**
 * Allows a player whether to pick or not
 * @param state The player can pick if this param is TRUE
 */
void InGE::Player::allowPick(bool state){
	mPick = state;
}

/**
 * Tells if a player can pick or not
 * @return 
 */
bool InGE::Player::canPick(){
	return mPick;
}
